...
public class JwtUtils {
    ...
    public static String generateToken(Usuario usuario) throws JsonProcessingException {
        ...
        return Jwts.builder().claim("userDetails", usuarioJson).setIssuer("br.com.fatec.drawingController")
                .setSubject(usuario.getNome()).setExpiration(new Date(agora.getTime() + hora))
